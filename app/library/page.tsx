...
function ResourceCard({
  ...
  const handleCardClick = async () => {
    if (downloaded) {
      ...
      alert(
        'You are offline and this resource is not downloaded.'
      );
    }
  };
  ...
  const handleDownloadClick = (e: React.MouseEvent) => {
    ...
    if (downloaded) {
      if (
        confirm(
          'Remove this download from offline storage?'
        )
      ) {
      ...
      <div className="p-5 flex flex-col flex-grow">
        ...
        <div className="mt-auto pt-4 border-t border-gray-50 flex flex-wrap gap-1.5">
          ...
          {(item.tags?.length || 0) > 3 && (
            <span className="text-[10px] text-gray-400 py-1 px-1 font-medium">
...
export default function LibraryPage() {
  ...
  useEffect(() => {
    ...
    const handleOffline = () => {
      setIsOffline(true);
      console.log(
        '⚠️ Offline detected. Attempting redirect...'
      );
      try {
  ...
  const fetchLibraryItems = async () => {
    ...
    try {
      ...
      if (selectedDiff !== 'All Difficulties')
        params.append('diff', selectedDiff);
      if (selectedType !== 'All')
  ...
  const handleUpload = async (
    ...
    if (file && file.size > MAX_SIZE) {
      alert(
        'File is too large! Please upload files smaller than 50MB or use an External Link.'
      );
      return;
    }
    ...
    <div className="min-h-screen bg-[#f7f7f5] text-[#151313]">
      ...
      <div className="ml-20">
        ...
        <main className="p-8 max-w-7xl mx-auto">
          ...
          <div
            className={cn(
              'bg-white p-4 rounded-2xl shadow-sm border border-gray-100 mb-8 space-y-4',
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    <div className="space-y-1">
                      ...
                      <Input
                        name="title"
                        required
                        className="bg-gray-50 font-medium border-gray-200"
                  ...
                  <div className="p-5 bg-gray-50 rounded-xl border border-gray-200 space-y-4">
                    <div className="space-y-1">
                      <label className="text-xs font-bold text-gray-900 uppercase tracking-wide flex justify-between items-center mb-1">
                        ...
                        <span className="text-[10px] text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded-full normal-case font-medium">
                    ...
                    <div className="relative flex justify-center text-[10px] uppercase font-bold text-gray-400">
                      <span className="bg-gray-50 px-2 relative z-10">
                        OR Upload File
                      </span>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-start gap-2 text-[10px] text-amber-600 bg-amber-50 p-2 rounded-lg border border-amber-100">
                        ...
                        <p>
                          Max file size: 50MB. For larger
                          videos, please use an external
                          link (YouTube/Vimeo) above.
                        </p>
                      </div>
                    </div>
                  </div>

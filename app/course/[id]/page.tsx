...
const courseData = {
  ...
  breadcrumb: [
    ...
    'Lesson 1. Introduction to Public Speaking and Leadership',
  ],
  modules: [
    {
      id: 1,
      title:
        '01. Introduction to Public Speaking and Leadership',
      duration: '40 min',
      lessons: [
        {
          id: 1,
          title: 'Overview of public speaking',
          duration: '8 min',
        },
        {
          id: 2,
        ...
        {
          id: 4,
          title: 'Understanding audience dynamics',
          duration: '6 min',
        },
      ],
    },
...
In this course, you'll learn the fundamentals of public speaking, from understanding your audience to mastering non-verbal communication. We'll cover techniques for crafting compelling messages, building confidence, and handling challenging situations.`,
  timestamps: [
    ...
    {
      time: '2:34',
      title: 'The Importance of Public Speaking',
    },
    { time: '5:46', title: 'Types of Public Speaking' },
    {
      time: '7:12',
      title: 'Key Elements of Effective Public Speaking',
    },
  ],
};
      ...
      <div className="ml-20">
        ...
        <main className="p-8">
          <div className="mb-6 text-sm text-gray-500">
            <span className="hover:text-[#ff5734] cursor-pointer">
              My courses
            </span>
            {' / '}
            <span className="hover:text-[#ff5734] cursor-pointer">
            ...
            {' / '}
            <span className="text-[#151313] font-semibold">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
              ...
              <div className="bg-white rounded-3xl p-6 shadow-sm">
                ...
                {activeTab === 'task' && (
                  <div className="text-gray-700">
                    ...
                    <p>
                      Record a 2-minute speech on a topic of
                      your choice and submit it for review.
                    </p>
                  </div>
                )}
              </div>
            ...
            <div className="bg-white rounded-3xl p-6 shadow-sm h-fit max-h-[800px] overflow-y-auto">
              <h2 className="text-2xl font-bold text-[#151313] mb-6">
                Course Content
              </h2>

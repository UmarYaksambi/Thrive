  ...
  if (isYoutube && videoId) {
    return (
      <div className="block">
        ...
        <div
          className={`transition-all duration-300 overflow-hidden ${showVideo ? 'max-h-[500px] mt-3 opacity-100' : 'max-h-0 opacity-0'}`}
        >
...
const LoadingAnimation = ({ stage }: { stage: number }) => {
  const stages = [
    ...
    {
      icon: Youtube,
      text: 'Finding YouTube tutorials in Hindi...',
      color: '#FF0000',
    },
    {
      icon: BookOpen,
      text: 'Searching open source resources...',
      color: '#be94f5',
    },
    {
      icon: FileText,
      text: 'Curating documentation and articles...',
      color: '#4CAF50',
    },
    {
      icon: Sparkles,
...
export default function PlannerPage() {
    ...
    modules: [
      {
        week: 1,
        title:
          'HTML और CSS की उन्नत अवधारणाएं (Advanced HTML & CSS Concepts)',
        description:
          'HTML5 और CSS3 के advanced features सीखें',
        lessons: [
          {
            ...
            resources: [
              {
                type: 'youtube',
                name: 'HTML5 in One Shot - CodeWithHarry',
                url: 'https://www.youtube.com/watch?v=BsDoLVMnmZs',
              },
              {
                type: 'youtube',
                name: 'HTML Tutorial for Beginners - Thapa Technical',
                url: 'https://www.youtube.com/watch?v=qHB2jUvPn0g',
              },
              {
                type: 'article',
                name: 'MDN Web Accessibility Guide',
          ...
          },
          {
            ...
            resources: [
              {
                type: 'youtube',
                name: 'CSS Grid Tutorial in Hindi - CodeWithHarry',
                url: 'https://www.youtube.com/watch?v=Ba-KKDHEjYo',
              },
              {
                type: 'youtube',
                name: 'Complete CSS Flexbox Tutorial - Thapa Technical',
                url: 'https://www.youtube.com/watch?v=R3GI7kLQ-Ek',
              },
              {
                type: 'course',
                name: 'CSS Grid Garden - Interactive Game',
          ...
          },
          {
            ...
            resources: [
              {
                type: 'youtube',
                name: 'CSS Animation Tutorial - Vinod Bahadur Thapa',
                url: 'https://www.youtube.com/watch?v=CL8xPGL-p6M',
              },
              {
                type: 'youtube',
                name: 'Advanced CSS Animations - WsCube Tech',
                url: 'https://www.youtube.com/watch?v=zHUpx90NerM',
              },
              {
                type: 'article',
                name: 'CSS Animation Guide - W3Schools',
          ...
          },
          {
            ...
            resources: [
              {
                type: 'youtube',
                name: 'Responsive Web Design Complete Course - CodeWithHarry',
                url: 'https://www.youtube.com/watch?v=ZdHQGrBBzwo',
              },
              {
                type: 'youtube',
                name: 'Mobile First Design - Thapa Technical',
                url: 'https://www.youtube.com/watch?v=VsNAuGkCpQU',
              },
              {
                type: 'course',
      ...
      },
      {
        week: 2,
        title:
          'जावास्क्रिप्ट - ES6 और आधुनिक फीचर्स (JavaScript - ES6 & Modern Features)',
        description:
          'Modern JavaScript concepts और best practices',
        lessons: [
          {
            ...
            resources: [
              {
                type: 'youtube',
                name: 'JavaScript ES6 Tutorial in Hindi - CodeWithHarry',
                url: 'https://www.youtube.com/watch?v=hGMWLYVRW7s',
              },
              {
                type: 'youtube',
                name: 'ES6 Complete Course - Thapa Technical',
                url: 'https://www.youtube.com/watch?v=NhZ5VfE6CpY',
              },
              {
                type: 'article',
          ...
          },
          {
            ...
            resources: [
              {
                type: 'youtube',
                name: 'Async JavaScript Tutorial - CodeWithHarry',
                url: 'https://www.youtube.com/watch?v=IHjzyhjKxtc',
              },
              {
                type: 'youtube',
                name: 'Promises in JavaScript Hindi - Thapa Technical',
                url: 'https://www.youtube.com/watch?v=NOzi4wBHn0o',
              },
              {
                type: 'article',
                name: 'JavaScript Promises - MDN',
          ...
          },
          {
            ...
            resources: [
              {
                type: 'youtube',
                name: 'JavaScript Modules Tutorial - WsCube Tech',
                url: 'https://www.youtube.com/watch?v=qgRUr-YUk1Q',
              },
              {
                type: 'youtube',
                name: 'ES6 Modules Explained Hindi',
                url: 'https://www.youtube.com/watch?v=cRHQNNcYf6s',
              },
              {
                type: 'article',
                name: 'ES6 Modules Guide',
          ...
          },
          {
            ...
            resources: [
              {
                type: 'youtube',
                name: 'JavaScript Debugging Tutorial - CodeWithHarry',
                url: 'https://www.youtube.com/watch?v=3PHXvlpOkf4',
              },
              {
                type: 'youtube',
                name: 'Error Handling in JS - Thapa Technical',
      ...
      },
      {
        week: 3,
        title:
          'DOM मैनिपुलेशन और इवेंट्स (DOM Manipulation & Events)',
        ...
        lessons: [
          {
            ...
            resources: [
              {
                type: 'youtube',
                name: 'DOM Manipulation Complete Guide - CodeWithHarry',
                url: 'https://www.youtube.com/watch?v=3PHXvlpOkf4',
              },
              {
                type: 'youtube',
                name: 'JavaScript DOM Tutorial Hindi - Thapa Technical',
                url: 'https://www.youtube.com/watch?v=IIHZkR4cqSc',
              },
              {
                type: 'course',
                name: 'JavaScript30 - DOM Projects',
          ...
          },
          {
            ...
            resources: [
              {
                type: 'youtube',
                name: 'JavaScript Events Tutorial - WsCube Tech',
                url: 'https://www.youtube.com/watch?v=VlkdT0bBhGI',
              },
              {
                type: 'youtube',
                name: 'Event Handling in JavaScript Hindi',
                url: 'https://www.youtube.com/watch?v=Nz4s19Th7ag',
              },
              {
                type: 'article',
                name: 'JavaScript Events - MDN',
          ...
          },
          {
            ...
            resources: [
              {
                type: 'youtube',
                name: 'Form Validation Tutorial - CodeWithHarry',
                url: 'https://www.youtube.com/watch?v=In0nB0ABaUk',
              },
              {
                type: 'youtube',
                name: 'JavaScript Form Validation Hindi - Thapa Technical',
          ...
          },
          {
            ...
            resources: [
              {
                type: 'youtube',
                name: 'Browser Storage Tutorial Hindi - WsCube Tech',
                url: 'https://www.youtube.com/watch?v=k8yJCeuP6I8',
              },
              {
                type: 'youtube',
                name: 'LocalStorage in JavaScript - CodeWithHarry',
                url: 'https://www.youtube.com/watch?v=AUOzvFzdIk4',
              },
              {
                type: 'article',
                name: 'Web Storage API Guide',
      ...
      },
      {
        week: 4,
        title:
          'React.js फंडामेंटल्स (React.js Fundamentals)',
        description:
          'Modern web applications के लिए React सीखें',
        lessons: [
          {
            ...
            resources: [
              {
                type: 'youtube',
                name: 'React JS Tutorial in Hindi - CodeWithHarry',
                url: 'https://www.youtube.com/watch?v=RGKi6LSPDLU',
              },
              {
                type: 'youtube',
                name: 'React Complete Course - Thapa Technical',
          ...
          },
          {
            ...
            resources: [
              {
                type: 'youtube',
                name: 'React State Management Hindi - WsCube Tech',
                url: 'https://www.youtube.com/watch?v=O6P86uwfdR0',
              },
              {
                type: 'youtube',
                name: 'Props and State in React - Love Babbar',
          ...
          },
          {
            ...
            resources: [
              {
                type: 'youtube',
                name: 'React Hooks Explained Hindi - CodeWithHarry',
                url: 'https://www.youtube.com/watch?v=mxK8b99iJTg',
              },
              {
                type: 'youtube',
                name: 'Complete React Hooks Tutorial - Thapa Technical',
                url: 'https://www.youtube.com/watch?v=O6P86uwfdR0',
              },
              {
                type: 'article',
          ...
          },
          {
            ...
            resources: [
              {
                type: 'youtube',
                name: 'React Lifecycle Tutorial Hindi - WsCube Tech',
                url: 'https://www.youtube.com/watch?v=abjeWy4sZiU',
              },
              {
                type: 'youtube',
                name: 'useEffect Hook Complete Guide - Love Babbar',
                url: 'https://www.youtube.com/watch?v=0ZJgIjIuY7U',
              },
              {
                type: 'article',
                name: 'useEffect Complete Guide',
  ...
  const calculateProgress = (
    weekIdx: ProgressCalculation['weekIdx']
  ): number => {
    // Force Week 1 (module.week === 1, index 0) to show 20% progress
    if (weekIdx === 0) return 20;

    const totalLessons =
      coursePlan.modules[weekIdx].lessons.length;
    const completed = coursePlan.modules[
      weekIdx
    ].lessons.filter(
      (_: unknown, lessonIdx: number) =>
  ...
  const getResourceIcon = (
    ...
    switch (type) {
      ...
      case 'course':
        return (
          <BookOpen className="w-4 h-4 text-[#be94f5]" />
        );
      case 'article':
        return (
          <FileText className="w-4 h-4 text-[#fccc42]" />
        );
      default:
      ...
      <div className="ml-20">
        ...
        <main className="p-8">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl font-bold text-[#151313] mb-2">
              Learning Planner
            </h2>
            <p className="text-gray-600 mb-12">
              Create a personalized learning path tailored
              to your goals and current level
            </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option>
                      Others (mention in Prerequisites)
                    </option>
                  </select>
                </div>
              </div>
            ...
            {isGenerating && (
              <LoadingAnimation stage={generationStage} />
            )}
                  ...
                  <div className="flex items-start justify-between mb-6 flex-wrap gap-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        Personalized learning journey in{' '}
                        {coursePlan.language}
                      </p>
                    </div>

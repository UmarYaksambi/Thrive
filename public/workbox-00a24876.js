define(['exports'], function (t) {
  ...
  class F {
    ...
    async expireEntries() {
      ...
      ((this.O = !1),
        this.k && ((this.k = !1), b(this.expireEntries())));
    }
    ...
    A() {
      ...
      for (const [s, n] of this.plugins.entries())
        n !== X.copyRedirectedCacheableResponsesPlugin &&
          (n === X.defaultPrecacheCacheabilityPlugin &&
            (t = s),
          n.cacheWillUpdate && e++);
      0 === e
        ? this.plugins.push(
      ...
      for (const n of t) {
        ...
        if (this.F.has(i) && this.F.get(i) !== t)
          throw new s(
            ...
            { firstEntry: this.F.get(i), secondEntry: t }
          );
        ...
        if (
          (this.F.set(i, t), this.H.set(i, r), e.length > 0)
        ) {
    ...
    (t.NetworkFirst = class extends v {
      ...
      async U(t, e) {
        ...
        const o = await e.waitUntil(
          (async () =>
            (await e.waitUntil(Promise.race(i))) ||
            (await a))()
        );

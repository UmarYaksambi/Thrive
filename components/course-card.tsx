...
const getCategoryBgClass = (
  ...
  if (category.toLowerCase().includes('marketing'))
    return 'learnify-yellow';
  if (category.toLowerCase().includes('computer'))
    return 'learnify-purple';
  if (category.toLowerCase().includes('psychology'))
    return 'learnify-blue';
  return 'learnify-purple';
};
...
export function CourseCard({
  ...
  return (
    <div
      className={cn('learnify-card p-6 relative', bgClass)}
    >
